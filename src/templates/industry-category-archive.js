    ...
    return (
        <Layout>
          ...
          <NewsSearch />
            ...
            <li className="hover:font-extrabold cursor-pointer list-none my-2 mx-5 p-2 blog-archive-cat rounded menu-endangerment"><AniLink fade to='/news/endangerment' activeStyle={{ color: 'black', fontWeight: '800', borderBottom: '2px solid black'}} >Endangerment</AniLink></li>
