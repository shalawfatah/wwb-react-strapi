            ...
            <div className="py-10 items-center footer ">
                <footer class="text-gray-700 body-font">
                    <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <Link to="/">
                        <img src={Image} alt="Image" class="w-12 bg-none" />
                        </Link>
                        <span class="text-xl">Worldwide Bee</span>
                        </a>
                    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 WWB —
                    <a href="https://twitter.com/shalawfatah" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@DevArt</a>
                    </p>
