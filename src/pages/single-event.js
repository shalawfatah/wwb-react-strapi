            ...
            <section className="text-gray-700 body-font">
                <div className="container px-5 py-0 mx-auto flex flex-col">
                    ...
                    <div className="container px-5 py-24 mx-auto">
                        ...
                        <h1 className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 font-bold">About this Event <br /> <span className="text-lg font-thin">Great style is easy. Article offers stylish modern, mid century, and scandinavian furniture from world renowned designers at accessible prices. Shop now.</span></h1>
                        <div>
                        <h1 className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 font-bold">Date and Time <br /> <span className="text-lg font-thin">13 May 2021</span></h1>
                        <h1 className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 font-bold">Location<br /> <span className="text-lg font-thin">2134 Address Street, Vancouver, B.C V1Y 1A1</span></h1>
                        </div>
                        </div>
