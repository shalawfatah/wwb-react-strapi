...
const Blog = () => {
    return (
        <Layout>
            ...
            <EducationCard headline="Bee title" content="lorem ipusm someone hi badsdsd lorem ipusm someone hi badsdsdlorem ipusm someone hi badsdsd lorem ipusm someone hi badsdsd"></EducationCard>
            <EducationCard headline="Bee title" content="lorem ipusm someone hi badsdsd"></EducationCard>
            <EducationCard headline="Bee title" content="lorem ipusm someone hi badsdsd"></EducationCard>
            <EducationCard headline="Bee title" content="lorem ipusm someone hi badsdsd"></EducationCard>
            <EducationCard headline="Bee title" content="lorem ipusm someone hi badsdsd"></EducationCard>
