                ...
                {genomes.map((genome)=> {
                  return (
                    ...
                    >
                      ...
                      <Popup>
                        <Img fluid={genome.bee_photo.childImageSharp.fluid} alt={genome.bee_name} className="rounded" />
                        ...
                        <AniLink fade to={`/genomes/${genome.slug}`} className="flex bg-gray-200 py-2 px-4 focus:outline-none text-lg cursor-pointer text-white rounded-full justify-center text-white hover:bg-gray-300 transition-all duration-500 ease-in-out no-underline">Read More</AniLink>
                      </Popup>
                    </Marker>
                </div>
                  )
